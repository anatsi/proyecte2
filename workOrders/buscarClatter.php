        ...
        echo "
          ...
          <thead id='theadmod'>
            <tr id='trmod'>
              ...
              <th scope='col' id='thmod'>CLATTER</th>
          ...
          "; foreach ($lista as $clatter) {
            //transformar fechas
            $fecha=explode("-", $clatter['fecha']);
            $fecha=$fecha[2]."-".$fecha[1]."-".$fecha[0];
             echo "
             <tr id='trmod'>
               <td data-label='VIN' id='tdmod'>".$clatter['bastidor']."</td>
               <td data-label='CLATTER' id='tdmod'>".$clatter['clatter']."</td>
               <td data-label='FECHA' id='tdmod'>".$fecha."</td>
               <td data-label='HORA' id='tdmod'>".$clatter['hora']."</td>
               <td data-label='USUARIO' id='tdmod'>".$clatter['usuario']."</td>
             </tr>
