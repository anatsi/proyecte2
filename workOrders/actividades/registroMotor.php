    ...
    <div class="site-content">
      <div class="container">
        <div class="breadcrumb" style="margin-left: 2%;">
          <a href="../../dashboard.php">INICIO</a> >> <a href="index.php">REGISTRO ACTIVIDADES</a> >> <a href="registroMotor.php">WEEKEND 25</a>
        </div>
        ...
        $recuentos = $motor -> cuentaListaMotor();
          ...
          <img onclick='location.reload(true);' src='data:image/png;base64,'>
            ...
            "; foreach ($lista as $motores) {
               echo "
                  <tr id='trmod'>
                    <td data-label='VIN' id='tdmod' class='bastidor'>".$motores['bastidor']."</td>
                    <td data-label='INFP' id='tdmod'>".$motores['motor']."</td>
                  </tr>
