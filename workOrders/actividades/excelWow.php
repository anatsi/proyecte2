...
if (isset($_GET['b'])) {
  ...
  $lista=$aullidos->listaAullidoFiltrados($filtro);
}else {
...
foreach ($lista as $aullido) {
  ...
  $objPHPExcel->setActiveSheetIndex(0)
  ->setCellValue('A'.$i, $aullido['bastidor'])
  ->setCellValue('B'.$i, $aullido['aullido'])
  ->setCellValue('C'.$i, $aullido['wow'])
  ->setCellValue('D'.$i, PHPExcel_Shared_Date::PHPToExcel( $aullido['fecha'] ))
  ->setCellValue('E'.$i, $aullido['hora'])
  ->setCellValue('F'.$i, $aullido['usuario'])
  ;
