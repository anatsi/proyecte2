    ...
    <div class="site-content">
      <div class="container">
        <div class="breadcrumb" style="margin-left: 2%;">
          <a href="../../dashboard.php">INICIO</a> >> <a href="index.php">REGISTRO ACTIVIDADES</a> >> <a href="registroReallocation.php">REALLOCATION</a>
        </div>
       ...
       <input type="text" id="busqueda" placeholder='FILTRAR'/><br/><br/>
        ...
        <!--tabla-->
        <?php
        $lista= $reallocation->listaReallocation();
        $recuentos = $reallocation -> cuentaListaReallocation();
              ...
              $fecha=$fecha[2]."-".$fecha[1]."-".$fecha[0];
               ...
               echo "
                  <tr id='trmod'>
                    ...
                    <td data-label='CLIMA' id='tdmod'>".$registro['destino']."</td>
