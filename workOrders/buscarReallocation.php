      ...
      $recuentos = $reallocations->cuentaListaReallocation();
        echo "
          ...
          "; foreach ($lista as $reallocation) {
            //transformar fechas
            $fecha=explode("-", $reallocation['fecha']);
            $fecha=$fecha[2]."-".$fecha[1]."-".$fecha[0];
             echo "
             <tr id='trmod'>
               <td data-label='VIN' id='tdmod'>".$reallocation['bastidor']."</td>
               <td data-label='FECHA' id='tdmod'>".$fecha."</td>
               <td data-label='HORA' id='tdmod'>".$reallocation['hora']."</td>
               <td data-label='CLIMA' id='tdmod'>".$reallocation['destino']."</td>
               <td data-label='USUARIO' id='tdmod'>".$reallocation['usuario']."</td>
             </tr>
      ...
      $reallocations= new Reallocation();
        ...
        <?php
            echo "
              ...
              "; foreach ($filtrados as $reallocation) {
                //transformar fechas
                $fecha=explode("-", $reallocation['fecha']);
                $fecha=$fecha[2]."-".$fecha[1]."-".$fecha[0];
                 echo "
