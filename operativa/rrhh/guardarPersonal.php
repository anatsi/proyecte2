...
//incluimos los archivos necesarios e inicializamos los objetos
  ...
  if ($_GET['e'] && $_GET['e'] == 1) {
      ...
      if (isset($_POST['avisar'])) {
        ...
        $para = 'jpratval@tsiberia.es, jsanc267@tsiberia.es, jlluecag@tsiberia.es, mdevita1@tsiberia.es, ariquelm@tsiberia.es, emart309@tsiberia.es, pablo.moreno.g@ts-iberica.com, acosinga@tsiberia.es, acosinga@ford.com, jpratval@ford.com, jsanc267@ford.com, jlluecag@ford.com, mdevita1@ford.com, ariquelm@ford.com, emart309@ford.com';
  ...
  //si alguna de las personas da error, se pondran la variable de arriba que toque a 1
    if ($_POST['noche']) {
      foreach ($_POST['noche'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'tn', $_POST['dia'], "rrhh");
      }
    ...
    if ($_POST['morning']) {
      foreach ($_POST['morning'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'tm', $_POST['dia'], "rrhh");
    ...
    if ($_POST['tarde']) {
      foreach ($_POST['tarde'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'tt', $_POST['dia'], "rrhh");
    ...
    if ($_POST['central']) {
      foreach ($_POST['central'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'tc', $_POST['dia'], "rrhh");
    ...
    if ($_POST['otro1']) {
      foreach ($_POST['otro1'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'otro1', $_POST['dia'], "rrhh");
    ...
    if ($_POST['otro2']) {
      foreach ($_POST['otro2'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'otro2', $_POST['dia'], "rrhh");
    ...
    if ($_POST['otro3']) {
      foreach ($_POST['otro3'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'otro3', $_POST['dia'], "rrhh");
    ...
    if ($_POST['otro4']) {
      foreach ($_POST['otro4'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'otro4', $_POST['dia'], "rrhh");
    ...
    if ($_POST['otro5']) {
      foreach ($_POST['otro5'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'otro5', $_POST['dia'], "rrhh");
    ...
    if ($_POST['otro6']) {
      foreach ($_POST['otro6'] as $personalNoche) {
        $nuevoEmpleado = $personal -> nuevoPersonal($_POST['id'], $personalNoche, 'otro6', $_POST['dia'], "rrhh");
